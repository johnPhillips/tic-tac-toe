# What / why
I set myself the challenge of building a working tic-tac-toe game in 60 min from a standing start.
...
# What next
When I next have a block of time I will challenge myself to add a minimax algorithm so that the user can play against AI.
